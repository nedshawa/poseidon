...
# Load: skills/Utilities/Parser/Workflows/ExtractYoutube.md
```
...
```typescript
import { PAI_THEME } from 'skills/Media/Remotion/theme'
...
- Load: `docs/USER/SKILLCUSTOMIZATIONS/Art/PREFERENCES.md`
- Apply: Charcoal aesthetic, purple accents, organic animations
- Reference: `skills/Media/Remotion/theme.ts`
