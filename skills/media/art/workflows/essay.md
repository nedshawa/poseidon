...
```bash
Read skills/Media/Art/SKILL.md
```
...
bun run skills/art/Tools/Generate.ts \
...
bun docs/Tools/RemoveBg.ts /path/to/output.png

# Or batch process multiple images
bun docs/Tools/RemoveBg.ts image1.png image2.png image3.png
```

**See:** `skills/Images/Workflows/BackgroundRemoval.md` for full documentation.
...
3. EMOTION → Match to register in docs/aesthetic.md
