...
```
docs/USER/SKILLCUSTOMIZATIONS/Agents/
...
bun run skills/Agents/Tools/ComposeAgent.ts --task "Review security"
bun run skills/Agents/Tools/ComposeAgent.ts --traits "security,skeptical,thorough"

# Persistent custom agents
bun run skills/Agents/Tools/ComposeAgent.ts --task "Security review" --save
bun run skills/Agents/Tools/ComposeAgent.ts --list-saved
bun run skills/Agents/Tools/ComposeAgent.ts --load "security-expert-skeptical-thorough"
bun run skills/Agents/Tools/ComposeAgent.ts --delete "security-expert-skeptical-thorough"

# Other options
bun run skills/Agents/Tools/ComposeAgent.ts --list
bun run skills/Agents/Tools/ComposeAgent.ts --output json
```
