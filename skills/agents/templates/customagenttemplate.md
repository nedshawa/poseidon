...
- **Built-in agents** (`agents/*.md`): Use this format for the persona section
- **Custom agents** (`custom-agents/*.md`): Use this format for the entire file
