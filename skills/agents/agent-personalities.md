...
**What happens:**
1. Run `bun run skills/Agents/Tools/ComposeAgent.ts` for EACH agent
...
- Trait definitions: `skills/Agents/Data/Traits.yaml`
- Agent template: `skills/Agents/Templates/DynamicAgent.hbs`
- Composition tool: `skills/Agents/Tools/ComposeAgent.ts`

---

## Named Agent Architecture

- **Location**: Individual agent files in `agents/*.md`
