...
**Save to:**
```
History/research/YYYY-MM-DD_[client]-recon/
...
```
History/research/YYYY-MM-DD_[client]-direct-injection/
├── findings.md
...
**Document findings in:**
```
History/research/YYYY-MM-DD_[client]-indirect-injection/
├── findings.md
├── poisoned-documents/
├── test-web-pages/
...
```
History/research/YYYY-MM-DD_[client]-multistage/
...
**Document in:**
```
History/research/YYYY-MM-DD_[client]-defenses/
...
**Deliverables:**
```
History/research/YYYY-MM-DD_[client]-final-report/
