...
`docs/USER/SKILLCUSTOMIZATIONS/AnnualReports/`
...
zes annual security reports from 570+ sources across the cybersecurity industry.
...
bun run skills/Security/AnnualReports/Tools/UpdateSources.ts

# List all sources
bun run skills/Security/AnnualReports/Tools/ListSources.ts [category]

# Fetch a specific report
bun run skills/Security/AnnualReports/Tools/FetchReport.ts <vendor> <report-name>
```
