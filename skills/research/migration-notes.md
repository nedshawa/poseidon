...
- **Source:** `commands/perform-claude-research.md`
- **Destination:** `skills/Research/Workflows/ClaudeResearch.md`
- **Size:** 3.6K
...
- **Source:** `commands/perform-perplexity-research.md`
- **Destination:** `skills/Research/Workflows/PerplexityResearch.md`
- **Size:** 8.1K
...
- **Source:** `commands/perform-interview-research.md`
- **Destination:** `skills/Research/Workflows/InterviewResearch.md`
- **Size:** 4.4K
...
- **Source:** `commands/analyze-ai-trends.md`
- **Destination:** `skills/Research/Workflows/AnalyzeAiTrends.md`
- **Size:** 3.0K
...
**Location:** `skills/Research/Workflows/`
...
The original command files remain in `commands/`:
