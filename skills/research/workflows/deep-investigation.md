...
```
memory/RESEARCH/{YYYY-MM}/{YYYY-MM-DD}_{topic-slug}/
```

Read `memory/STATE/current-work.json` for the active work directory.
...
Templates live at `skills/Research/Templates/{DomainName}.md`
