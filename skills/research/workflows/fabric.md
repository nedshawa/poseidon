...
**Primary Skill:** `skills/Utilities/Fabric/SKILL.md`
**Patterns Location:** `skills/Utilities/Fabric/Patterns/`
...
Patterns are managed by the Fabric skill at `skills/Utilities/Fabric/`.
...
```bash
ls skills/Utilities/Fabric/Patterns/
```
...
**Full Pattern List:** `ls skills/Utilities/Fabric/Patterns/`
**Fabric Skill:** `skills/Utilities/Fabric/SKILL.md`
**Fabric Documentation:** https://github.com/danielmiessler/fabric
**Pattern Templates:** See `skills/Utilities/Fabric/Patterns/official_pattern_template/`
