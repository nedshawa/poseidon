...
```bash
bun run skills/Utilities/Prompting/Tools/RenderTemplate.ts \
...
```bash
bun run skills/Utilities/Prompting/Tools/ValidateTemplate.ts \
...
- `docs/Prompting.md` (Templating section)
- `History/research/2025-12/2025-12-09-templating-system-research.md`
- `History/learnings/2025-12/2025-12-09-021700_LEARNING_complete-templating-system-and-evals-integration.md`
