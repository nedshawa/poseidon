...
**Location:** `skills/Utilities/Fabric/Patterns/`
...
```bash
skills/Utilities/Fabric/Tools/update-patterns.sh
```
...
All templates live in `skills/Utilities/Prompting/Templates/`:
...
**CLI Usage:**
```bash
bun skills/Utilities/Prompting/Tools/RenderTemplate.ts \
...
**Programmatic Usage:**
```typescript
import { renderTemplate } from 'skills/Utilities/Prompting/Tools/RenderTemplate.ts';
