...
```bash
bun skills/[SkillName]/Tools/[ToolName].ts --help
```
...
```bash
grep -l "Intent-to-Flag" skills/[SkillName]/Workflows/*.md
```
...
**Reference:** `docs/CliFirstArchitecture.md`
