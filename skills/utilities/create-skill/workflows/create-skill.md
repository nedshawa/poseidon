...
1. Read the skill system documentation: `docs/SkillSystem.md`
2. Read the canonical example: `skills/Research/SKILL.md`
...
```bash
mkdir -p skills/[SkillName]/Workflows
mkdir -p skills/[SkillName]/Tools
```

**Example:**
```bash
mkdir -p skills/YourSkill/Workflows
mkdir -p skills/YourSkill/Tools
```
...
**Full documentation:** `docs/THENOTIFICATIONSYSTEM.md`
...
```bash
touch skills/[SkillName]/Workflows/[WorkflowName].md
```
...
**Reference:** `docs/CliFirstArchitecture.md` (Workflow-to-Tool Integration section)

**Examples (TitleCase):**
```bash
touch skills/YourSkill/Workflows/UpdateDaemonInfo.md
touch skills/YourSkill/Workflows/UpdatePublicRepo.md
touch skills/YourSkill/Workflows/Create.md
touch skills/YourSkill/Workflows/Publish.md
```
...
```bash
ls skills/[SkillName]/
ls skills/[SkillName]/Workflows/
ls skills/[SkillName]/Tools/
```
