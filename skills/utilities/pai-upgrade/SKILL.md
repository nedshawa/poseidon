...
zed upgrade recommendations for the user's existing PAI setup by understanding their context and discovering what's new in the ecosystem.
...
Read and analyze:
- docs/USER/TELOS/TELOS.md
- docs/USER/TELOS/GOALS.md
- docs/USER/TELOS/PROJECTS.md
- docs/USER/TELOS/CHALLENGES.md
- docs/USER/TELOS/STATUS.md
...
Run: bun skills/Utilities/PAIUpgrade/Tools/Anthropic.ts
...
**User Customizations** (`docs/USER/SKILLCUSTOMIZATIONS/PAIUpgrade/`):
