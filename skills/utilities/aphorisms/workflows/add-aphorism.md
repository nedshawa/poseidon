...
**Prerequisites:**
- Aphorism database exists at `skills/aphorisms/Database/aphorisms.md`
...
**Read database:**
```bash
Read skills/aphorisms/Database/aphorisms.md
```
...
Edit(
  file_path=skills/aphorisms/Database/aphorisms.md,
