...
**Reference:** `docs/CliFirstArchitecture.md` (Configuration Flags section)
...
For more information, see Bin/{{CLI_NAME}}/README.md
...
Documentation: Bin/{{CLI_NAME}}/README.md
```
...
3. Read: Bin/notioncli/README.md
...
Use proven structure from Bin/llcli/ as reference.
