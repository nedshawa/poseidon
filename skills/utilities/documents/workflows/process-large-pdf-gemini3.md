...
import { insertNewsletterContent } from 'skills/parser/db';
...
- For traditional PDF extraction (text-only), see `skills/documents/pdf/SKILL.md`
- For PDF form filling, see `skills/documents/pdf/forms.md`
- For parser integration, see `skills/parser/SKILL.md`
- For newsletter database schema, see `Context/databases/newsletter/schema.sql`
