...
`docs/USER/SKILLCUSTOMIZATIONS/Browser/`
...
**Headless by default.** All automation runs headless. When the user says "show me", open the URL in their preferred browser from `docs/USER/TECHSTACKPREFERENCES.md`:
...
**Agent definitions:** `agents/BrowserAgent.md` and `agents/UIReviewer.md`
