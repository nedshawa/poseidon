...
```bash
# Check prompts exist
ls skills/Utilities/Evals/UseCases/<name>/prompts/
...
Create `skills/Utilities/Evals/UseCases/<name>/comparisons/<comparison-name>.yaml`:
...
bun run Templates/Tools/RenderTemplate.ts \
  ...
  -d skills/Utilities/Evals/UseCases/<name>/comparisons/<name>.yaml \
  -o skills/Utilities/Evals/UseCases/<name>/comparisons/<name>-setup.md \
  --preview
```
