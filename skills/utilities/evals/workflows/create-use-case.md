...
```bash
mkdir -p skills/Utilities/Evals/UseCases/<name>/{test-cases,golden-outputs,prompts}
```

### Step 3: Create Config File

Create `skills/Utilities/Evals/UseCases/<name>/config.yaml`:
...
Create `skills/Utilities/Evals/UseCases/<name>/prompts/v1.0.0.md`:
...
Create test cases in `skills/Utilities/Evals/UseCases/<name>/test-cases/`:
...
Create `skills/Utilities/Evals/UseCases/<name>/README.md`:
...
\`\`\`bash
bun run skills/Utilities/Evals/EvalServer/cli-run.ts --use-case <name>
\`\`\`
...
```bash
# Check structure
ls -la skills/Utilities/Evals/UseCases/<name>/

# Validate config
bun run skills/Utilities/Evals/EvalServer/cli.ts use-case show <name>
```
...
bun run skills/Utilities/Evals/EvalServer/cli-run.ts \
  --use-case <name> \
  --test-id 001-basic \
  --verbose
```
