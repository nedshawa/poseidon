...
Create `skills/Utilities/Evals/UseCases/<name>/judge-config.yaml`:
...
bun run Templates/Tools/RenderTemplate.ts \
  -t Evals/Judge.hbs \
  -d skills/Utilities/Evals/UseCases/<name>/judge-config.yaml \
  -o skills/Utilities/Evals/UseCases/<name>/judge-prompt.md \
  --preview
```
