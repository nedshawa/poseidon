...
name: telos
description: >-
  Life OS and project analysis — goals, dependencies, beliefs, wisdom, books, movies, narrative points, interview extraction, McKinsey reports, and project dashboards. USE WHEN Telos, life goals, projects, dependencies, books, movies, beliefs, wisdom, update TELOS, narrative points, interview extraction, write report, McKinsey report, TELOS report, project analysis, dashboard, n=24.
---
...
zations/projects (relationships, dependencies, goals, progress)
...
|--------------|---------|----------|
| "my TELOS", "my goals", "my beliefs", "add to TELOS" | Personal TELOS | `docs/USER/TELOS/` |
...
All files located in `docs/USER/TELOS/`:
...
```bash
# View specific file
read docs/USER/TELOS/GOALS.md
read docs/USER/TELOS/BELIEFS.md

# View recent updates
read docs/USER/TELOS/updates.md
```
...
1. **Dual Context** - Handles both personal and project TELOS seamlessly
   - Personal TELOS: `docs/USER/TELOS/` (in CORE USER directory)
...
**Remember:** Personal TELOS files live at `docs/USER/TELOS/` (in the CORE USER directory)
