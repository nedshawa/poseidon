...
cp -r skills/Telos/ReportTemplate/* {output_dir}/
...
Edit files in `skills/Telos/ReportTemplate/components/`

**To change color scheme:**
Edit CSS custom properties in `skills/Telos/ReportTemplate/app/globals.css`
