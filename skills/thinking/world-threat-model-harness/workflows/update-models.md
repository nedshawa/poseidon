...
- Model template at `skills/Thinking/WorldThreatModelHarness/ModelTemplate.md`
...
```
Read memory/RESEARCH/WorldModels/INDEX.md (if exists)
...
Save to: `memory/RESEARCH/WorldModels/{horizon}.md`

### Step 5: Update INDEX

Write/update `memory/RESEARCH/WorldModels/INDEX.md`:
