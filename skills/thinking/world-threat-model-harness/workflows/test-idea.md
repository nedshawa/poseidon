...
- World models must exist at `memory/RESEARCH/WorldModels/`
...
```
Check memory/RESEARCH/WorldModels/ for all 11 model files.
...
Read all 11 model files from `memory/RESEARCH/WorldModels/`.
