...
`docs/USER/SKILLCUSTOMIZATIONS/OSINT/`
...
```
memory/WORK/$(jq -r '.work_dir' memory/STATE/current-work.json)/YYYY-MM-DD-HHMMSS_osint-[target]/
```

**Archived reports:**
```
History/research/YYYY-MM/[target]-osint/
```
