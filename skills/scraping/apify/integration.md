...
**Location:** `skills/social/SKILL.md`
...
2. System runs: `bun filesystem-mcps/apify/get-latest-tweet.ts`
...
bun filesystem-mcps/apify/get-user-tweets.ts ThePrimeagen 10

# Analyze Paul Graham's recent thoughts
bun filesystem-mcps/apify/get-user-tweets.ts paulg 20

# Track Simon Willison's posts
bun filesystem-mcps/apify/get-user-tweets.ts simonw 15
```
...
bun filesystem-mcps/apify/get-latest-thread.ts
...
bun filesystem-mcps/apify/get-latest-tweet.ts
...
✅ Run from `filesystem-mcps/apify/` directory or use full path
...
**For Users:**
- Quick reference: `filesystem-mcps/SCRIPTS-REFERENCE.md`
- Social skill: `skills/social/SKILL.md`

**For Developers:**
- Implementation: `filesystem-mcps/apify/README.md`
- Standards: `filesystem-mcps/STANDARDS.md`
- Parent guide: `filesystem-mcps/README.md`
