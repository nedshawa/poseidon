...
- [Founding Principles](founding-principles.md) — 23 principles governing Poseidon's design
...
- [Hook System](hook-system.md) — 6 hooks + 25 handlers, latency budgets, event lifecycle
...
- [Regime System](regime-system.md) — Governance enforcement, declarative policies, compliance audit

## Operations
- [CLI Architecture](cli-architecture.md) — poseidon.ts wrapper, 24 CLI tools, LLM-agnostic
